...
public class ChromeDinosaur extends JPanel implements ActionListener, KeyListener {
    ...
    public ChromeDinosaur() {
        ...
        cactus1Img = new ImageIcon(getClass().getResource("/img/big-cactus1.png")).getImage();
        cactus2Img = new ImageIcon(getClass().getResource("/img/big-cactus2.png")).getImage();
        cactus3Img = new ImageIcon(getClass().getResource("/img/big-cactus3.png")).getImage();
